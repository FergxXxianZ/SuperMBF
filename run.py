    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://facebook.com/paradox.paradox.5836')
                time.sleep(2)
                menu()
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.facebook.com/paradox.paradox.5836')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def mini():
    ...
    try:
        ...
        print logo
        print 40 * '\x1b[1;97m\xe2\x95\x90'
        print '\x1b[1;91m[ INFO ] Akun Facebook Target Harus Berteman Dengan Akun Anda Dulu !'
        try:
...
def scrak():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x9c\x96] Tidak Ada Kkoneksi'
...
def brute():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] File Tidak Ditemukan...'
            print '\n\x1b[1;91m[!] \x1b[1;92mSepertinya Anda Tidak Memiliki Wordlist'
            tanyaw()
...
def lain():
    ...
    print '\x1b[1;37;40m6. ->Coming soon<-'
    print
    print '\x1b[1;31;40m0. Kembali'
    print
    pilih_lain()
...
def check_akun():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] File Fidak Ditemukan'
            raw_input('\n\x1b[1;91m[ \x1b[1;97mKembali \x1b[1;91m]')
            lain()
